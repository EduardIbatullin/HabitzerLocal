...
class HabitTrackerDatabase:
    ...
    def add_habit(self, user_id, habit_name, habit_description, habit_frequency, reminder_time_from, reminder_time_till):
        ...
        self.execute_query(query, (user_id, habit_name, habit_description, habit_frequency, habit_start_date, reminder_time_from, reminder_time_till))
